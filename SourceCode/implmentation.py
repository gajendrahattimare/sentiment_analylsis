...
dataset = pd.read_csv(r"C:\Users\GAJJU\Documents\Sentiment_in_Social_Media\Data\dataset.csv",encoding='latin-1')
...
Train_X, Test_X, Train_Y, Test_Y = model_selection.train_test_split(dataset['text_final'],dataset['Result'],test_size=0.3)
...
Naive Bayes Accuracy Score ->  67.73816481589714
Naive Bayes Cofusion Matrix ->  [[303  27 109]
 [ 78  95 295]
 [ 28  15 761]]
 

SVM (linear) Accuracy Score ->  74.92694330800701
SVM Cofusion Matrix ->  [[329  88  22]
 [ 82 284 102]
 [ 35 100 669]]



RF->  72.35534774985388
RF Cofusion Matrix ->  [[319  82  38]
 [ 87 288  93]
 [ 60 113 631]]
 
 
 
KNN->  57.21800116890707
KNN Cofusion Matrix ->  [[222 189  28]
  [ 69 303  96]
 [ 53 297 454]]
"""